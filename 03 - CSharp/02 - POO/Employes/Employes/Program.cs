...
namespace Employes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Employes e3 = new Employes("BUPONT", "Jacques", new DateTime(2020, 11, 23), "vendeur",100000, "Commercial",a2, new List<Enfants> { enf3 });
            ...
            Console.WriteLine("Le nombre d'employés crées : "+tab.Count);
