...
{
echo '<div class="caseListe donneeListe">'.$unObjet->getLibelleProduit().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getPrix().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getDateDePeremption().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getCategories().'</div>';
