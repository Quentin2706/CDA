...
CREATE TABLE `categories` (
  ...
  `libelle` varchar(101) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `categories` VALUES (1,NULL,'test'),(2,1,'fezefzfzfz'),(3,NULL,'dzdzd'),(4,NULL,'dzdzdz'),(5,1,'ffrzfrfezqfzeq'),(6,5,'BLABLABLABLABLA'),(7,NULL,'dzda');
