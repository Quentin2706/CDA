...
INSERT INTO `avoir_note` VALUES (1,1,1,20),(2,2,1,20),(3,3,1,20),(4,4,1,20),(5,5,1,20),(6,6,1,20),(7,7,1,20),(8,17,1,20),(9,18,1,20),(10,1,2,20),(11,2,2,20),(12,3,2,20),(13,4,2,20),(14,5,2,20),(15,6,2,20),(16,7,2,20),(17,17,2,20),(18,18,2,20),(19,8,3,20),(20,9,3,20),(21,10,3,20),(22,11,3,20),(23,12,3,20),(24,13,3,20),(25,14,3,20),(26,15,3,20),(27,16,3,20),(28,8,4,20),(29,9,4,20),(30,10,4,20),(31,11,4,20),(32,12,4,20),(33,13,4,20),(34,14,4,20),(35,15,4,20),(36,16,4,20),(37,17,4,20);
...
--
-- Temporary table structure for view `etudiantsnoteepreuves`
--

DROP TABLE IF EXISTS `etudiantsnoteepreuves`;
/*!50001 DROP VIEW IF EXISTS `etudiantsnoteepreuves`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `etudiantsnoteepreuves` AS SELECT 
 1 AS `idEtudiant`,
 1 AS `nomEtudiant`,
 1 AS `prenomEtudiant`,
...
--
-- Temporary table structure for view `yatoula`
--

DROP TABLE IF EXISTS `yatoula`;
/*!50001 DROP VIEW IF EXISTS `yatoula`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `yatoula` AS SELECT 
 1 AS `idEtudiant`,
 1 AS `nomEtudiant`,
 1 AS `prenomEtudiant`,
 1 AS `adresseEtudiant`,
...
--
-- Final view structure for view `etudiantsnoteepreuves`
--
...
/*!50001 VIEW `etudiantsnoteepreuves` AS select `e`.`idEtudiant` AS `idEtudiant`,`e`.`nomEtudiant` AS `nomEtudiant`,`e`.`prenomEtudiant` AS `prenomEtudiant`,`e`.`adresseEtudiant` AS `adresseEtudiant`,`e`.`villeEtudiant` AS `villeEtudiant`,`e`.`codePostalEtudiant` AS `codePostalEtudiant`,`e`.`telephoneEtudiant` AS `telephoneEtudiant`,`e`.`dateEntreeEtudiant` AS `dateEntreeEtudiant`,`e`.`anneeEtudiant` AS `anneeEtudiant`,`e`.`remarqueEtudiant` AS `remarqueEtudiant`,`e`.`sexeEtudiant` AS `sexeEtudiant`,`e`.`dateNaissanceEtudiant` AS `dateNaissanceEtudiant`,`a`.`idAvoirNote` AS `idAvoirNote`,`a`.`note` AS `note`,`ep`.`idEpreuve` AS `idEpreuve`,`ep`.`libelleEpreuve` AS `libelleEpreuve`,`ep`.`idEnseignantEpreuve` AS `idEnseignantEpreuve`,`ep`.`idMatiereEpreuve` AS `idMatiereEpreuve`,`ep`.`dateEpreuve` AS `dateEpreuve`,`ep`.`CoefficientEpreuve` AS `CoefficientEpreuve`,`ep`.`anneeEpreuve` AS `anneeEpreuve` from ((`etudiants` `e` join `avoir_note` `a` on((`e`.`idEtudiant` = `a`.`idEtudiant`))) join `epreuves` `ep` on((`a`.`idEpreuve` = `ep`.`idEpreuve`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `yatoula`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `yatoula` AS select `e`.`idEtudiant` AS `idEtudiant`,`e`.`nomEtudiant` AS `nomEtudiant`,`e`.`prenomEtudiant` AS `prenomEtudiant`,`e`.`adresseEtudiant` AS `adresseEtudiant`,`e`.`villeEtudiant` AS `villeEtudiant`,`e`.`codePostalEtudiant` AS `codePostalEtudiant`,`e`.`telephoneEtudiant` AS `telephoneEtudiant`,`e`.`dateEntreeEtudiant` AS `dateEntreeEtudiant`,`e`.`anneeEtudiant` AS `anneeEtudiant`,`e`.`remarqueEtudiant` AS `remarqueEtudiant`,`e`.`sexeEtudiant` AS `sexeEtudiant`,`e`.`dateNaissanceEtudiant` AS `dateNaissanceEtudiant`,`a`.`idAvoirNote` AS `idAvoirNote`,`a`.`note` AS `note`,`ep`.`idEpreuve` AS `idEpreuve`,`ep`.`libelleEpreuve` AS `libelleEpreuve`,`ep`.`idEnseignantEpreuve` AS `idEnseignantEpreuve`,`ep`.`idMatiereEpreuve` AS `idMatiereEpreuve`,`ep`.`dateEpreuve` AS `dateEpreuve`,`ep`.`CoefficientEpreuve` AS `CoefficientEpreuve`,`ep`.`anneeEpreuve` AS `anneeEpreuve`,`ens`.`nomEnseignant` AS `nomEnseignant`,`ens`.`prenomEnseignant` AS `prenomEnseignant`,`ens`.`fonctionEnseignant` AS `fonctionEnseignant`,`ens`.`adresseEnseignant` AS `adresseEnseignant`,`ens`.`villeEnseignant` AS `villeEnseignant`,`ens`.`codePostalEnseignant` AS `codePostalEnseignant`,`ens`.`telephoneEnseignant` AS `telephoneEnseignant`,`ens`.`dateNaissanceEnseignant` AS `dateNaissanceEnseignant`,`ens`.`dateEmbaucheEnseignant` AS `dateEmbaucheEnseignant`,`mat`.`nomMatiere` AS `nomMatiere`,`mat`.`idModule` AS `idModule`,`mat`.`coefficientMatiere` AS `coefficientMatiere`,`modu`.`nomModule` AS `nomModule`,`modu`.`coefficientModule` AS `coefficientModule`,`fc`.`idFaireCours` AS `idFaireCours`,`fc`.`annee` AS `annee` from ((((((`etudiants` `e` join `avoir_note` `a` on((`e`.`idEtudiant` = `a`.`idEtudiant`))) join `epreuves` `ep` on((`a`.`idEpreuve` = `ep`.`idEpreuve`))) join `enseignants` `ens` on((`ep`.`idEnseignantEpreuve` = `ens`.`idEnseignant`))) join `matieres` `mat` on((`ep`.`idMatiereEpreuve` = `mat`.`idMatiere`))) join `modules` `modu` on((`mat`.`idModule` = `modu`.`idModule`))) join `faire_cours` `fc` on((`mat`.`idMatiere` = `fc`.`idMatiere`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
