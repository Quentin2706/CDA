...
echo '<label for=IdArticle class="caseForm labelForm">'."Article".'</label>';
echo creerSelect($_GET["id"],"Articles",["LibelleArticle"],$disabled, null, "libelleArticle ASC");
echo '<div class="caseForm infoForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm checkForm"><i class="fas fa-check-circle"></i></div>';

echo '<label for=Quantite class="caseForm labelForm">'."Quantite".'</label>';
